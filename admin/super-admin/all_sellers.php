...
<head>
    ...
    <title>Admin | All Branch List</title>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-primary edit-seller" data-toggle="modal" data-target="#editModal" data-id="<?php echo $row['id']; ?>" data-loginemail="<?php echo $row['email']; ?>" data-loginpassword="<?php echo $row['login_password']; ?>"><a href="#"><i class="fas fa-edit"></i></a></span>
