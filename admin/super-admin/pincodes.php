...
<head>
    ...
    <title>Admin | Add Pincodes</title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Add Pincodes</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="pincode" name="pincode" placeholder="Enter pin code here">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#pincodeForm').on('submit', function(event) {
                    ...
                    formData.append('action', 'addPincode');
