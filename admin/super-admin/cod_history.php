                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT dh.*, db.* FROM delivery_history dh JOIN delivery db ON dh.delivery_boy_id = db.id";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-danger delete-cod" data-order_id="<?php echo $row['order_id']; ?>"><a href="#"><i class="fas fa-trash"></i> Clear Blance</a></span>
                                                    </td>
                                                </tr>
                                            <?php
                                                $index++;
