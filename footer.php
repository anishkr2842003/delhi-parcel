        ...
        <section class="">
          <div class="row">
            ...
            <div class="col-md-12 col-lg-4 mt-3">
              <a href="index.php"> <img class="logo bg-white border-radius-5px" src="assets/images/logo.png" alt="Logo"></a>
              <br><br>
              <em>
                Delhi Parcel offers the best door-to-door courier service in Delhi NCR. We guarantee safe and timely delivery of your packages. Enjoy the lowest prices without compromising on quality. Experience top-notch service that sets us apart in the industry!
              </em>
            </div>
            ...
            <div class="col-12 col-lg-4 row">
              ...
              <div class="col-6  mt-3">
                ...
                <em>
                  <a class="text-white" href="about.php">Pricing</a>
                </em><br>
                <!-- <em>
                <a class="text-white" href="about.php">About-Us</a>
              </em><br> -->
                <em>
                  <a class="text-white" href="about.php">Book Parcel</a>
                </em><br>
                <em>
                  <a class="text-white" href="about.php">Track Order</a>
                </em><br>
                <em>
                  <a class="text-white" href="service.php">Our Services</a>
                </em>
              </div>
              ...
              <div class="col-6 mt-3">
                ...
                <em>
                  <a class="text-white" href="privacy.php">Privacy & Policy</a>
                </em><br>
                <em>
                  <a class="text-white" href="terms&cond.php">Terms & Conditions</a>
                </em><br>
                <em>
                  <a class="text-white" href="refund.php">Cancellation & Refund Policy</a>
                </em>
              </div>
            </div>
