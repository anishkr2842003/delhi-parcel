...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="dashboard.php" class="brand-link">
    ...
    <span class="brand-text font-weight-light"><b style="color: black;"><?php echo $_SESSION['delivery_boy_name'] ? $_SESSION['delivery_boy_name'] : 'Delivery Boy' ?></b></span>
  </a>
  <!-- Sidebar -->
  <div class="sidebar">
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <!-- Pickup -->
        <li class="nav-item">
          <a href="pickup.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'pickup.php' ? 'active' : ''; ?>">
        ...
        <!-- Delivery -->
        <li class="nav-item">
          <a href="delivery.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'delivery.php' ? 'active' : ''; ?>">
